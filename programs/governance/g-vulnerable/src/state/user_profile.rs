...
// Tracks stake amount which determines voting eligibility
// Role level automatically updates based on reputation thresholds
#[account]
#[derive(InitSpace)]
...
pub enum MemberRanks {
 ...
 impl MemberRanks {
    ...
    // Prevents manual role manipulation by deriving from reputation
...
// Username Registry
//
// SECURITY: Prevents username squatting and ensures uniqueness
// Uses PDA with username as seed to guarantee one owner per username
// The 'claimed' flag indicates if the username is taken
#[account]
#[derive(InitSpace)]
